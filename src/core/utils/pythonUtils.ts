...
// user-controllable via a workspace's python.defaultInterpreterPath setting;
// interpolating it into a shell command string would be OS command injection (CWE-78).
