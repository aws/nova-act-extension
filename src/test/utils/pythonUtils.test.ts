...
describe('PythonUtils Test Suite', () => {
  ...
  // Regression: OS command injection via python interpreter path (Vigilance #3885194 / CWE-78).
  // The interpreter path is attacker-controllable via a workspace's `.vscode/settings.json`
